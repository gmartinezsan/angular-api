...
namespace Heroes.API.Controllers
{
    ...
    public class HeroesController : ControllerBase
    {
        ...
        // GET: api/Heroes
        // using name parameter which can be empty
        [HttpGet]
        public async Task<ActionResult<IEnumerable<HeroValue>>>
        GetHeroValue([FromQuery] string name)
        {
            // Define a LINQ query
            ...
            {
                heroquery = heroquery.Where(h => h.name.Contains(name));
            }
        ...
        PutHeroValue(int id, HeroValue heroValue)
        {
            if (id != heroValue.id)
            {
                return BadRequest();
        ...
        // more details, see https://go.microsoft.com/fwlink/?linkid=2123754.
        [HttpPost]
        public async Task<ActionResult<HeroValue>>
